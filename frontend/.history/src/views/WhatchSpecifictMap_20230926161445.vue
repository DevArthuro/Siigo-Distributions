...
onMounted(() => {
  ...
  graph.addNode(data.locations[0].id, { x: data.locations[0].x, y: data.locations[0].y, size: 5, label: data.locations[0].label, color: "blue" });
  graph.addNode(data.locations[1].id, {  x: data.locations[1].x, y: data.locations[1].y, size: 5, label: data.locations[1].label, color: "blue" });
  graph.addNode(data.locations[2].id, {  x: data.locations[2].x, y: data.locations[2].y, size: 5, label: data.locations[2].label, color: "blue" });
