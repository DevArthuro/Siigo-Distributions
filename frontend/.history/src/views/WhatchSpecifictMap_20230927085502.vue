<template>
    ...
    <div class="container  mt-4">
      ...
      <div class="row">
        ...
        <div class=" col-lg-7 ms-lg-3 col-ms-12 row">
            <div id="sigma-container" class="sigma-container col-10" style="height: 80vh; padding: 0; margin: 0 magin-top: 10px;"></div>
            <div class="align-items-center">
              <button class="h4 btn btn-warning col-1">></button>
            </div>
        </div>
      </div>
    </div>
